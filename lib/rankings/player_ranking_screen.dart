...
class _PlayerRankingScreenState extends State<PlayerRankingScreen>
  ...
  void initState() {
    super.initState();
    final controller = Get.find<PlayerRankingController>();
  ...
  Widget build(BuildContext context) {
    final PlayerRankingController controller = Get.find();
          ...
          children: [
            AppSegmentedTabs(
              ...
              items: sports
                  .map(
                    (sport) => AppTabItem(
                      label: sport == SportType.cricket
                          ? 'Cricket'
                          : 'Football',
                      icon: sport == SportType.cricket
...
class _RankingTabContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final restEntries = entries.length > 3
        ? entries.sublist(3)
...
class _PodiumCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: id.isEmpty ? null : () => _openPlayerProfile(id),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _PodiumStatsBar(
                            entry: entry,
                            showFullStats: style.showFullStats,
                          ),
                        ],
                      ),
                    ),
  ...
  void _openPlayerProfile(String id) {
    Get.toNamed(
...
class _PodiumAvatarFrame extends StatelessWidget {
  const _PodiumAvatarFrame({
    required this.url,
  ...
  @override
  Widget build(BuildContext context) {
    final outer = style.avatarSize + style.ringWidth * 2 + 8;
    ...
    return Container(
      ...
      child: Center(
        child: Container(
          width: style.avatarSize + style.ringWidth * 2,
          height: style.avatarSize + style.ringWidth * 2,
...
class _PodiumStatsBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: PlayerStatsRow.fromLeaderboard(
        entry,
        compact: !showFullStats,
      ),
    );
  }
}
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 10),
                PlayerAvatar(url: avatar, size: 44, userId: id),
