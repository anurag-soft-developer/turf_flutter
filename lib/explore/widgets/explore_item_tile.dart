...
import 'explore_player_row.dart';
import 'explore_team_row.dart';
    ...
    return switch (item) {
      ...
      ExplorePlayerItem(:final player) => Padding(
          ...
          child: Material(
            ...
            child: UserListTile(helper: UserFieldInstance(player)),
          ),
        ),
      ExploreTeamRowItem(:final title, :final items) => ExploreTeamRow(
          title: title,
          items: items,
        ),
      ExplorePlayerRowItem(:final title, :final items) => ExplorePlayerRow(
          title: title,
          items: items,
        ),
    };
