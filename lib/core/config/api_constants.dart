...
class MatchmakingEndpoints {
  ...
  /// Active challenge opponent ids, keyed by our team (sent + received).
  String get activeOpponentIds => '/matchmaking/active-opponent-ids';
...
/// `GET /chat/inbox`, `GET /chat/messages`,
/// `POST /chat/read`, `POST /chat/hide`, `GET /chat/read-cursors`.
class ChatEndpoints {
  const ChatEndpoints();
